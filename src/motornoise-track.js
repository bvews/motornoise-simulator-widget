...
function MotornoiseTrack(audioContext, audioEntry, powerFrequency, powerVolume, brakeFrequency, brakeVolume, regenerationLimit, isRunningNoise) {
 ...
 */
MotornoiseTrack.prototype.update = function (speed, acceleration) {
...
MotornoiseTrack.prototype.stop = function () {
    if (!this._audioContext || !this._audioEntry || !this._audioEntry.buffer) {
        return;
    }
...
MotornoiseTrack.prototype._updateSound = function (pitch, volume) {
